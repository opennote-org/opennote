...
impl From<crate::entity::metadata_settings::Model> for MetadataSettings {
    fn from(value: crate::entity::metadata_settings::Model) -> Self {
        Self {
...
impl From<MetadataSettings> for crate::entity::metadata_settings::Model {
