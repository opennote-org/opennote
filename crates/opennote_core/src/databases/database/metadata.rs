...
impl From<crate::entities::metadata_settings::Model> for MetadataSettings {
    fn from(value: crate::entities::metadata_settings::Model) -> Self {
        Self {
...
impl From<MetadataSettings> for crate::entities::metadata_settings::Model {
