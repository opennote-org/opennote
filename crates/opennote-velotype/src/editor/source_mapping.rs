...
impl Editor {
    ...
    /// A publicly accessible method to retrieve the raw text for saving.
    pub fn get_editor_value(&self, cx: &App) -> String {
        self.document.markdown_text(cx)
    }

    pub fn get_editor_value_raw(&self, cx: &App) -> String {
